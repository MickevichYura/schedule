...
public class GroupScheduleList extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        final String gid = req.getParameter("gid");
        final University university = University.values()[Integer.valueOf(uid)];
        List<Lesson> lessonModelList = null;
        try {
            lessonModelList = university.getUniversityAdapter().getGroupScheduleList(gid);
